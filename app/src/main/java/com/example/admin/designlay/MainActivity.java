...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Toolbar toolbar;
    String[] roll_no = new String[]{"13", "208"};
    String[] name = new String[]{"Abhishek Mathur", "Ramesh Kumar Thorati"};
    String[] pa = new String[]{"0", "1"};
    String[] comment = new String[]{"he came late", "he came late again"};
